...
public class CheckServiceImpl implements CheckService {
    ...
    public void processOrder(String[] args) {
        ...
        writeCheckToFile(checkItems, finalDiscountCardNumber, balance, totalPrice, totalDiscount);
        printCheckToConsole();
    }
    ...
    @Override
    public void writeCheckToFile(List<CheckItem> checkItems, String discountCardNumber, double balance, double totalPrice, double totalDiscount) {
        ...
        // Запись в CSV файл
        try {
            CSVWriter.write("result.csv", data);
        } catch (IOException e) {
            throw new CheckException("INTERNAL SERVER ERROR: Error writing to result.csv");
        }
    }
